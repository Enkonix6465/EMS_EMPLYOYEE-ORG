...
import CareerDevelopmentTest from './pages/CareerDevelopmentTest';
    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/" element={user ? <Layout /> : <Navigate to="/login" />}>
          ...
          <Route path="career-development-test" element={<CareerDevelopmentTest />} />
          <Route path="admin-payroll" element={
            <RoleGuard allowedRoles={['admin', 'super_admin', 'hr']}>
              <AdminPayroll />
            </RoleGuard>
          } />
        </Route>
