                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="flex-shrink-0 h-10 w-10">
                          {/* User initials */}
                          <div 
                            className="h-10 w-10 rounded-full border-2 border-gray-200 dark:border-gray-600 bg-gradient-to-br from-blue-500 to-indigo-600 text-white font-bold text-sm flex items-center justify-center"
                          >
                            {user.name ? 
